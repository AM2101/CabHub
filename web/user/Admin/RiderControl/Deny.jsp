...
//        out.println(ids);
        ...
        String qry = "UPDATE registeration SET status = \"Deny\" WHERE id= "+ids;
...
//                alert("ID password invalid");
                window.location.href = "../?page=Rider&table=Pending&msg=Deny";
                </script>
            <%
            }else{
                   %>
            <script>
                alert("Not Update");
                window.location.href = "./?page=Rider&table=Pending&msg=notDeny";
                </script>
            <%
            }
        }catch(Exception e){
