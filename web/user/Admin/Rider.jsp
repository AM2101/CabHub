...
<!--    <button
    ...
    <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarNav">
      <ul class="navbar-nav w-100 d-flex justify-content-evenly">
        <li class="nav-item ">
          <a class="nav-link " id="Active" aria-current="page" href="?page=Rider&table=Active">List of Riders</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" id="Blocked" href="?page=Rider&table=Blocked">Blocked Rider</a>
        </li>
              </ul>
    </div>
  </div>
