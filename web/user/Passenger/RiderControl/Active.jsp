...
//                                    out.println(email);
                                    ...
                                    String finde = "SELECT * from booking where  email=?";
                    ...
                    //                      new Login(rs.getInt("id"));
                                  ...
                                  String qry = "SELECT * FROM booking Where status=\"Active\" and email=?";
                            ...
                            <div class="container">
                                <table class="table align-middle mb-0 bg-white">
                                    ...
                                    %>
                                    <tr>
                                        <td colspan="9"><h3 style="color: red">There is Nothing to Show</h3></td>
